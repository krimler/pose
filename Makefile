...
tlc: FlexPaxosGraph.tla PipelinedReconfigOpt.tla AdversarialAdapt.tla CrashRecovery.tla
	...
	java -jar $(TLA2TOOLS) -config CrashRecovery_N10.cfg CrashRecovery.tla
